    ...
    <div class="navigation-section bg-white flex flex-row md:flex-col items-center justify-center fixed px-10 md:px-3 inset-x-0 bottom-0 md:inset-y-0 md:bottom-0 md:left-0 md:inset-x-auto border-t-2 md:border-r-2">
        <div class="head-navigation">
          <?php if (isset($_SESSION['login'])):?>
            <a href="<?= BASEURL;?>profiles/user/<?= $_SESSION['username'] ?>/<?= $_SESSION['id'] ?>" class="photo-profile w-8 p-3"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="navigation flex flex-row md:flex-col items-center justify-center w-12 mx-auto md:my-12">
            ...
            <a href="#voted" class="nav-item mx-3 md:my-4 <?php if (exploded($_SERVER['REQUEST_URI'])[0]=='voted') {echo 'active'; }?>"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
